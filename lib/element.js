...
function elementsInitializer(requests, client) {
  ...
  function initElem(ElementInstance) {
    function element(selector, ...rest) {
      const selectorObj = {using: 'css selector', value: selector}
      return new ElementInstance(selectorObj, this.sessionId, null, this, ...rest)
    }
  ...
  function initElems(ElementsInstance) {
    function elements(selector, ...rest) {
      const selectorObj = {using: 'css selector', value: selector}
      return new ElementsInstance(selectorObj, this.sessionId, this, ...rest)
    }
    elements.css = function(selector, ...rest) {
      const selectorObj = {using: 'css selector', value: selector}
      return new ElementsInstance(selector, this.sessionId, this, ...rest)
    }
  ...
  class ElementAWB {
    ...
    constructor(selector, sessionId = null, elementId = null, baseElement = null, ...rest) {
      ...
      this.element = initElem.call(this, ElementAWB)
      this.elements = initElems.call(this, ElementsAWB)
      this.$ = initElem.call(this, ElementAWB)
      this.$$ = initElems.call(this, ElementsAWB)
      this.parent = false
