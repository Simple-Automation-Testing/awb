...
function elementsInitializer(requests, client) {
  ...
  function initElem(...args) {
    ...
    element.css = function(selector) {
      const selectorObj = {using: 'css selector', value: selector}
      return new Element(selectorObj, this.sessionId, null, this)
    }
    element.xpath = function(selector) {
      const selectorObj = {using: 'xpath', value: selector}
      return new Element(selectorObj, this.sessionId, null, this)
    }
    element.id = function(selector) {
      const selectorObj = {using: 'id', value: selector}
      return new Element(selectorObj, this.sessionId, null, this)
    }
    element.accessibilityId = function(selector) {
  ...
  function initElems(...args) {
    ...
    elements.css = function(selector) {
      const selectorObj = {using: 'css selector', value: selector}
      return new Elements(selector, this.sessionId, this)
    }
    elements.xpath = function(selector) {
      const selectorObj = {using: 'xpath', value: selector}
      return new Elements(selector, this.sessionId, this)
    }
    elements.id = function(selector) {
      const selectorObj = {using: 'id', value: selector}
      return new Elements(selector, this.sessionId, this)
    }
    elements.accessibilityId = function(selector) {
      const selectorObj = {using: 'accessibility id', value: selector}
      return new Elements(selector, this.sessionId, this)
    }
    return elements
  ...
  class Element {
    ...
    async waitUntilDisappear(time, index) {
      ...
      if(error) return InterfaceError(JSON.stringify(error))
      return negativeTime
    }
  ...
  class Elements {
    ...
    async getElements(...args) {
      ...
      if(!this.elements.length) {
        return InterfaceError(`Elements with selector ${JSON.stringify(this.selector)} not found`)
      }
