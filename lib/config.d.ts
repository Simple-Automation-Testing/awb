...
export interface Config {
  withStandalon?: boolean, // if true will run selenium standalone server when call start startDriver(), default true
  ...
  port?: string, // port on what will be runned browser driver 
