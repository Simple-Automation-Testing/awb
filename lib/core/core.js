...
const modulesProviders = {
  ...mobilePart,
  cookieClearAll: require('./cookieClearAll'),
  cookieGetAll: require('./cookieGetAll'),
  cookieClearOne: require('./cookieClearOne'),
  cookieSetOne: require('./cookieSetOne'),
  ...
  alertSetText: require('./alertSetText'),
  alertAccept: require('./alertAccept'),
  alertDismiss: require('./alertDismiss'),
  alertText: require('./alertText'),
  windowRect: require('./windowRect'),
  openTab: require('./openTab'),
  killSession: require('./killSession'),
  initSession: require('./initSession'),
  buttonDown: require('./buttonDown'),
  buttonUp: require('./buttonUp'),
  findElements: require('./findElements'),
  findElement: require('./findElement'),
  goToUrl: require('./goTo'),
  windowSource: require('./windowSource'),
  pressKeys: require('./pressKeys'),
  ...
  parentFrame: require('./toParentFrame'),
  tagName: require('./tagName'),
